        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-800/50 border border-slate-700 text-slate-300 text-sm font-medium mb-8">
              ...
              <span>Trusted by 500+ Industrial Partners</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight mb-8 leading-tight">
              Empowering the Best in <br/>
              <span className="text-[#F97316]">Heavy Industry.</span>
            </h1>
            
            <p className="text-xl text-slate-400 leading-relaxed font-light max-w-2xl mx-auto mb-12">
              We are the critical supply chain backbone for India's leading manufacturing powerhouses, infrastructure giants, and mining enterprises.
            </p>

            <div className="flex flex-wrap justify-center gap-8 text-slate-300">
              <div className="flex items-center gap-3">
                <Building2 className="w-5 h-5 text-slate-500" />
                <span className="font-medium">12+ Sectors</span>
              </div>
              <div className="flex items-center gap-3">
                <TrendingUp className="w-5 h-5 text-slate-500" />
                <span className="font-medium">99.9% Fulfillment</span>
              </div>
            </div>
          </div>
        </div>
